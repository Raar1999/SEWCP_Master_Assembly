...
| CP-IF-8 | To RF Bracket (SEWCP-900) | Bolted electrical land | Machined flat land, **60 mm circumferential × 18 mm radial, mean radius 137 mm (Ø274 BC), centred at 105°**, on the bottom face; **anodize-masked, Alodine 1200 only**; 2× M6 × 12 deep tapped at r = 137, 98.7° and 111.3°; **plus 2× M6 × 12 deep bracket taps at r = 150, 88° and 122°** (RF-IF-3 hanger mounting — ECR-Q-012 DEC-02 as corrected by its addendum: the r = 137 window is occupied by the 30°-pitch choke slots; r = 150 at ±17° clears the choke, ring-bolt, locator, land, RTD and channel patterns) |
...
| 5 | **Friction stir weld** the lid to the body | Circumferential + internal rib passes; no filler, no flux, no elastomer in the pressure boundary. **Internal-rib passes on the 5.0 design rib (ECR-Q-011 disposition, DEC-03): tapered probe, tip Ø ≤ 4.0 — the shoulder rides the continuous lid; seam tracking ≤ ±0.5; penetration 6.5–7.0 (0.5–1.0 into the rib). Supplier capability confirmed at RFQ** |
