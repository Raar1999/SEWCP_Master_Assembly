# SEWCP-500 — Electrostatic Chuck

**Component:** 04 of 09 · **Part Number:** SEWCP-500 · **WBS:** 3.5
**Status:** Not started
...
> content. Populating it is a Phase P2 activity under WBS 3.5.
...
- [`spec/04_SEWCP-500_Electrostatic_Chuck.md`](../../spec/04_SEWCP-500_Electrostatic_Chuck.md) — component specification
...
2. The parameter master for SEWCP-500 exists under `params/parts/`.
3. WBS 3.5 predecessors are complete per SEDEP-PMP-001 §3.1.
