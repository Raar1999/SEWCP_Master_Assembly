# SEWCP-900 — RF Feedthrough Bracket

**Component:** 08 of 09 · **Part Number:** SEWCP-900 · **WBS:** 3.9
**Status:** Not started
...
> content. Populating it is a Phase P2 activity under WBS 3.9.
...
- [`spec/08_SEWCP-900_RF_Feedthrough_Bracket.md`](../../spec/08_SEWCP-900_RF_Feedthrough_Bracket.md) — component specification
...
2. The parameter master for SEWCP-900 exists under `params/parts/`.
3. WBS 3.9 predecessors are complete per SEDEP-PMP-001 §3.1.
