...
**Component:** 05 of 09 · **Part Number:** SEWCP-600 · **WBS:** 3.6
**Status:** Not started
...
> content. Populating it is a Phase P2 activity under WBS 3.6.
...
- [`spec/05_SEWCP-600_Lift_Pins.md`](../../spec/05_SEWCP-600_Lift_Pins.md) — component specification
...
2. The parameter master for SEWCP-600 exists under `params/parts/`.
3. WBS 3.6 predecessors are complete per SEDEP-PMP-001 §3.1.
